                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context)!.contactDetailsDescription1,
                          style: TextStyle(
                            color: defaultColorWhite,
                          ),
                        ),
                        ...
                        Text(
                          AppLocalizations.of(context)!.contactDetailsDescription2,
                          style: TextStyle(
                            color: defaultColorWhite,
                          ),
                        ),
                                      ...
                                      if (!contactCubit.checkbox) {
                                        final snackBar = SnackBar(
                                          ...
                                          content: AwesomeSnackbarContent(
                                            ...
                                            message: AppLocalizations.of(context)!.contactError,
