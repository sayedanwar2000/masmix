...
Color defaultColorOrange = const Color(0xfff7921c);
Color defaultColorNavyBlue = const Color(0xff000236);
Color defaultColorLightOrange = const Color(0xffffbd50);
Color defaultColorWhite = Colors.white;
